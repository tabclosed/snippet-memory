...
snippet-memory is a program that runs on your computer and stores snippets (blocks of codes or text) in its database. You can access it via a browser at your local address or at any address from your LAN. The aim of the program is to provide a simple way of saving text and having it accessible from any device with a single click.

Some features are:

- Access from any device (ie: laptop, mobile, tv, fridge). As long as your device can open a web page you can have access to all your code blocks or any text you save in the program's database. No previous configuration required.
...
- Tagging: Easily search your database using specific tags you assign to your snippet.
...
I use linux version and works very well. Arm and windows versions are untested but should work. 
